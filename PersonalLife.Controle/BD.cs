    ...
    public class BD
    {
        ...
        public Entidade PesquisaId(Entidade objTabela)
        {
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                if (dr.HasRows)
                {                       
                    objTabela.IdUsuario = Convert.ToInt32(dr["IdUsuario"]);                    
                }
                else
                {
        ...
        public List<Entidade> PerfilCliente(Entidade objTabela)
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                //Dandos s parâmetros para o comando funcionar
                cn.CommandText = "SELECT * FROM Usuario WHERE usuario = @usuario";
                cn.Connection = con;
                cn.Parameters.Add("usuario", SqlDbType.VarChar).Value = objTabela.Usuario;
                SqlDataReader dr;
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        dado.IdUsuario = Convert.ToInt32(dr["idUsuario"]);
        ...
        public List<Entidade> ListaEx(Entidade objTabela)
        {
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                //Dandos s parâmetros para o comando funcionar
                cn.CommandText = "SELECT * FROM ClienteExercicio WHERE idUsuario = @id2";
                cn.Parameters.Add("id2", SqlDbType.VarChar).Value = objTabela.Id2;
                cn.Connection = con;
                SqlDataReader dr;
                List<Entidade> Lista = new List<Entidade>();
                dr = cn.ExecuteReader();
                if (dr.HasRows)
                {
                    ...
                    {
                        Entidade dado = new Entidade();
                        dado.IdExercicio = Convert.ToInt32(dr["idExercicio"]);
                        dado.Exercicio = Convert.ToString(dr["exercicio"]);
                        dado.Repeticao = Convert.ToInt32(dr["repeticao"]);
                        dado.Descanso = Convert.ToInt32(dr["descanso"]);
                        dado.Sessao = Convert.ToInt32(dr["sessao"]);
                        Lista.Add(dado);
                    }
                }
                return Lista;
        ...
        public void ExUsu(Entidade objTabela)
        {
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                //Dandos s parâmetros para o comando funcionar
                cn.CommandText = "INSERT INTO ClienteExercicio VALUES (@id1, @id2, @exercicio, @repeticao1, @descanso1, @sessao1)";
                cn.Parameters.Add("id1", SqlDbType.VarChar).Value = objTabela.Id1;
                cn.Parameters.Add("id2", SqlDbType.VarChar).Value = objTabela.Id2;
                cn.Parameters.Add("exercicio", SqlDbType.VarChar).Value = objTabela.Exercicio;
                cn.Parameters.Add("repeticao1", SqlDbType.VarChar).Value = objTabela.Repeticao1;
                cn.Parameters.Add("descanso1", SqlDbType.VarChar).Value = objTabela.Descanso1;
                cn.Parameters.Add("sessao1", SqlDbType.VarChar).Value = objTabela.Sessao1;
                //Abrindo mais uma conexão
                cn.Connection = con;
                cn.ExecuteNonQuery();
            }
        ...
        public string CalcImc(Entidade objTabela)
        {
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandText = "SELECT SUM(peso / (altura * altura)) AS total FROM Usuario WHERE usuario = @usuario";
                cn.Parameters.Add("usuario", SqlDbType.VarChar).Value = objTabela.Usuario;
                cn.Connection = con;
                SqlDataReader dr;
                //List<Entidade> Pesquisa = new List<Entidade>();
